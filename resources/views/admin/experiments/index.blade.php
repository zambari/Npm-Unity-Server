...
<main class="container">
    <div class={{config('app.main_div_style')}}>
        ...
        <x-collapsible-card name="Data wipe" id="experimentsCollapse" :expanded="false">
        <div class="card mb-4">
        <div class="card-body">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <a href="{{ route('admin.experiments.download-dump') }}" class="btn btn-primary">
                ...
                <div class="col-md-4">
                    ...
                    <form method="POST" action="{{ route('admin.experiments.clear-data') }}" onsubmit="return confirm('⚠️ WARNING: This will permanently delete ALL users, packages, scopes, releases, and release artifacts. This action cannot be undone! Are you absolutely sure?');">
                        @csrf
                ...
                <div class="col-md-4">
                    ...
                    <form method="POST" action="{{ route('admin.experiments.nuke-data') }}" onsubmit="return confirm('⚠️⚠️⚠️ CRITICAL WARNING: This will DROP ALL TABLES from the database, destroying the entire database structure! This action CANNOT be undone! Are you ABSOLUTELY CERTAIN?');">
                        @csrf
                ...
                <div class="col-md-4">
                    ...
                    <form method="POST" action="{{ route('admin.experiments.restore-dump') }}" enctype="multipart/form-data" onsubmit="return confirm('This will replace all current database data with the uploaded dump. Continue?');">
                        @csrf
        ...
        <div class="card-body">
            ...
            <div class="alert alert-info mb-3 d-flex justify-content-between align-items-center">
                ...
                @if(count($storageStats['incoming']['packages']) > 0)
                    <form method="POST" action="{{ route('admin.experiments.delete-all-incoming-but-latest') }}" 
                        ...
                        <tbody>
                            @foreach($storageStats['incoming']['packages'] as $package)
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="{{ route('admin.experiments.delete-incoming-package') }}" 
            ...
            <div class="alert alert-info mb-3 d-flex justify-content-between align-items-center">
                ...
                @if(count($storageStats['processed']['files']) > 0)
                    <form method="POST" action="{{ route('admin.experiments.delete-all-processed-but-latest') }}" 
                        ...
                        <tbody>
                            @foreach($storageStats['processed']['files'] as $file)
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="{{ route('admin.experiments.delete-processed-file') }}" 
    ...
    <x-collapsible-card name="Example data creator" id="exampleDataCollapse" :expanded="false">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.experiments.create-example-data') }}" 
